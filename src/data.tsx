  ...
  "blocks": [
      {
          ...
          "title": "Заговорите на тайском уже через 3 месяца",
          "imageKeyword": "Thailand",
          "content": "Хотите заговорить на тайском языке, но не знаете с чего начать? Хотите быстро и эффективно овладеть языком? Тогда курс тайского языка от Alpha Language School — это то, что вам нужно! За 3 месяца обучения вы научитесь говорить на тайском языке без акцента и сможете беспрепятственно общаться с местными жителями, понимать тайскую культуру и традиции.",
          "alignment": "left"
      },
      {
          "id": "features",
          ...
          "features": [
              ...
              },
              {
                  ...
                  "subtitle": "Мы поможем вам получить годовую учебную визу для дальнейшего обучения в Таиланде",
                  "icon": "book-open"
              },
              {
                  "title": "Высокий уровень доверия у студентов и иммиграционки",
                  "subtitle": "Наши студенты регулярно получают надежные и квалифицированные рекомендации от иммиграционной службы и образовательных учреждений",
                  "icon": "thumbs-up"
              }
          ]
      },
      ...
      },
      {
          ...
          "questions": [
              ...
              },
              {
                  ...
                  "answer": "Требования к студентам отсутствуют. Курс подходит для всех желающих изучить тайский язык."
              },
              {
