const data = {
    ...
    "subtitle": "Изучите английский язык с носителем языка на тропическом острове среди единомышленников.",
        ...
        },
        {
            ...
            "features": [
                ...
                },
                {
                    ...
                    "subtitle": "Общайтесь в чате с нашими студентами, которые готовятся к изучению английского языка",
                    "icon": "message-square"
                },
                {
            ...
            "questions": [
                {
                    ...
                    "answer": "Наши курсы длительностью от 1 до 12 недель. В течение этого периода вы будете заниматься 20 часов в неделю."
                },
                {
                    "question": "Входят ли проживание и еда в стоимость курса?",
                    "answer": "Проживание и еда не входят в стоимость курса, но мы поможем вам найти жилье и рестораны в вашем бюджете."
                },
                {
                    "question": "Какие методики обучения применяются на курсе?",
                    "answer": "Мы применяем современные инновационные методики обучения, включая коммуникативный метод и метод PBL (Project Based Learning)."
                }
            ]
        },
        {
