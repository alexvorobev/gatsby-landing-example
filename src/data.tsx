const data = {
  ...
  blocks: [
    ...
    },
    {
      ...
      subtitle:
        'Общайтесь в чате с нашими студентами, которые готовятся к изучению английского языка. Общайтесь в чате с нашими студентами, которые готовятся к изучению английского языка',
      features: [
        {
